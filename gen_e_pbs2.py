...
print("#PBS -l select=1:ncpus=2:mem=20gb ")
...
print("python3 par_elas_qmc.py ${PBS_ARRAY_INDEX} 6")
print("python3 par_elas_qmc.py ${PBS_ARRAY_INDEX} 7")
print("python3 par_elas_qmc.py ${PBS_ARRAY_INDEX} 8")
